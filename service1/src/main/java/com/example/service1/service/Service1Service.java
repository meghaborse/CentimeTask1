...
public class Service1Service {
    ...
    public String orchestrate(Map<String, String> payload) {
        ...
        //call service2
        String service2Response = restTemplate.getForObject("http://localhost:8082/service2/hello", String.class);
        //call service3
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<Map<String, String>> request = new HttpEntity<>(payload, headers);
        String service3Response = restTemplate.postForObject("http://localhost:8083/service3/concat", request, String.class);
